...
This file records third-party material and external repositories consulted,
copied, adapted, or linked by AI-for-Physics.

## google-deepmind/science-skills

- Status: copied-verbatim
- Original author: Google DeepMind / Google LLC
- Original repository: https://github.com/google-deepmind/science-skills
- Original file/path: `skills/`, `README.md`, `LICENSE`, `SKILL_LICENSES.md`, `plugin.json`
- Version used: `0b72c64f63bc5ddf0e5fe96b8c3eb02e10fd5ef8`
- Original license: Apache-2.0 for software; CC-BY-4.0 for other materials; upstream skill data-source terms are documented in `SKILL_LICENSES.md`
- Date accessed: 2026-05-22
- Location in this repo: `skills/third-party/google-deepmind-science-skills/`
- Changes made: none
- Notes: Users remain responsible for terms of use for third-party data sources referenced by individual skills.
...
- Original file/path: permissively triaged directories under `scientific-skills/`, plus `README.md` and `LICENSE.md`
- Version used: `66d1ad45ccbfe18f8665cd72d1ecb1043cd678f9`
- Original license: repository-level MIT; copied skills were limited to entries with permissive metadata or no per-skill override under the MIT-licensed repository
- Date accessed: 2026-05-22
- Location in this repo: `skills/third-party/k-dense-scientific-agent-skills/`
- Changes made: none
- Notes: `skills/third-party/k-dense-scientific-agent-skills/COPIED_SKILLS.md` records the copied and skipped skill list. Skills marked Unknown, GPL, proprietary, or otherwise unclear were not copied.

### CC BY 4.0 skill attribution within K-Dense copied subset
...
- Status: linked-only
- Original author: tririver
- Original repository: https://github.com/tririver/skills
- Original file/path: not applicable
- Version used: `4656bcf078896ac9e76c32b0ba25951c1298ccd8`
- Original license: no license file found as of 2026-05-22
- Date accessed: 2026-05-22
- Location in this repo: `skills/third-party/linked-only/tririver-arxiv-reading.md` and `skills/third-party/linked-only/tririver-cited-by.md`
- Changes made: none
- Notes: No text, code, examples, or files from this repository were copied or adapted.

## ChenLiu-1996/figures4papers

- Status: linked-only
- Original author: Chen Liu
- Original repository: https://github.com/ChenLiu-1996/figures4papers
- Original file/path: not applicable
- Version used: `ebebf0e6d96b9ec9c03d497356f7081c1801933a`
- Original license: no license file found as of 2026-05-22
- Date accessed: 2026-05-22
- Location in this repo: `skills/third-party/linked-only/figures4papers.md`
- Changes made: none
- Notes: No text, code, examples, or files from this repository were copied or adapted.
